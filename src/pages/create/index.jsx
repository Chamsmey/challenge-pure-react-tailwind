...
const CreatePage = () => {
  ...
  return (
    <div className="w-2/3 m-auto ">
      {/* // form header */}
      <div>
        <h1 className="text-center text-xl font-bold">Create course</h1>
      </div>
      ...
      >
        ...
        <div className="flex justify-end gap-1 border-t-2 py-2">
          <button onClick={addNewChapter} className=" flex gap-2 items-center border rounded-2xl bg-blue-200/70 p-2 px-4">
            <CiCirclePlus className="" />{" "}
            new Chapter
          </button>
          <button onClick={submit} className="p-2 px-4 bg-gray-100 border  rounded-2xl bg-green-200/70 ">
            save
          </button>
        </div>
      </form>
